...
[Sample HTML report here](docs/sample_report.zip?raw=true) for a randomized dataset created using explain.dalibo.com sample plans. AI hint is at day may 4, real reports are more meaningful due to detailed context you can provide to AI analisys. 
